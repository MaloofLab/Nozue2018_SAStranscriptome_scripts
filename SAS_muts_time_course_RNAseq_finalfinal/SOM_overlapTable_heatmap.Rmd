...
set.seed(2) # Set a random seed so that SOM results are reproducible
  for(i in 1:10) {
    ssom1.5 <- som(as.matrix(data5), somgrid(1,5,"hexagonal"),rlen=10000)
    ...
    ssom2.3 <- som(as.matrix(data5), somgrid(2,3,"hexagonal"),rlen=10000) 
    plot(ssom2.3, type = "codes")
    ssom1.7 <- som(as.matrix(data5), somgrid(1,7,"hexagonal"),rlen=10000) 
    plot(ssom1.7, type = "codes")
    ssom2.4 <- som(as.matrix(data5), somgrid(2,4,"hexagonal"),rlen=10000) 
    plot(ssom2.4, type = "codes")
    ssom3.3 <- som(as.matrix(data5), somgrid(3,3,"hexagonal"),rlen=10000) 
    plot(ssom3.3,type="codes")
    ssom2.5 <- som(as.matrix(data5), somgrid(2,5,"hexagonal"),rlen=10000) 
    plot(ssom2.5, type = "codes") #
    ssom3.4 <- som(as.matrix(data5), somgrid(3,4,"hexagonal"),rlen=10000) 
    plot(ssom3.4) 
    ssom4.4 <- som(as.matrix(data5), somgrid(4,4,"hexagonal"),rlen=10000) 
