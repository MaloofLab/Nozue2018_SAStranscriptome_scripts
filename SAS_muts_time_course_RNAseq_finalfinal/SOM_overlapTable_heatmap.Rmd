...
pdf(paste("SOMset",i,"pdf",sep="."));plot(ssom1.7, type = "codes")
...
# save objects
save(ssom1.7,ssom2.4,ssom3.3,ssom2.5,ssom3.4,ssom4.4,file=file.path("..","..","Nozue2016_SAStranscriptome_output","output","SOM_overlapTable_heatmap",paste("ssom.set",i,"Rdata",sep=".")))
  }
}
SOMcluster(data5)
```
...
som.summary<-data.frame(ssom1.7=ssom1.7$unit.classif,
