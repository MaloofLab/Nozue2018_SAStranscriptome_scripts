...
# making loop or function for drawing Fig2 graph
...
my.category.heatmap.all <- plot_grid(my.category.heatmap.graph[[1]]+theme(legend.position="none"), 
                      ...
                      ncol=3,nrow=5,
                      label_size = 50)
save_plot(file.path("..","..","Nozue2016_SAStranscriptome_output","output","tsne_dbscan_overlapTable_heatmap",paste("FigS4_all.my.category.expression.pattern.v16.log2.signif.v2.",title,".png",sep="")), my.category.heatmap.all,
...
```
# the end of custom category heatmap (shade responsiveness) (Fig. 2 and Spplemental Dataset 4 (zipped))
