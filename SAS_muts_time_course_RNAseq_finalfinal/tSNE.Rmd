...
tsne.dbscan.eps.MinPts.set.files.list<-sapply(file.path("..","..","Nozue2016_SAStranscriptome_output","output","tsne_dbscan_overlapTable_heatmap",tsne.dbscan.eps.MinPts.set.files),function(x) mget(load(x)))
...
tsne.dbscan.eps.MinPts.set.files.list.DF$AGI<-rownames(data5)
save(tsne.dbscan.eps.MinPts.set.files.list.DF,file=file.path("..","..","Nozue2016_SAStranscriptome_output","output","tsne_dbscan_overlapTable_heatmap","tsne.dbscan.summary.set.files.DF.Rdata"))
```
