...
categories <- read.csv("../../Nozue2016_SAStranscriptome_output/figs_tables/TableS7_test.wozero.melt.hormone.significant.s.111816.csv",row.names=1,as.is=TRUE)
summary(categories)
head(categories)
...
test<-read.csv("../../Nozue2016_SAStranscriptome_output/figs_tables/TableS4_hormone.responsiveness.SOMclusters.csv") # needs to revise
test<-test[,-1]
