...
# homedir<-"/Volumes/Data8new/Data8/NGS_related/Arabidopsis_analysis/Nozue2016_SAStranscriptome_finalfinal_newVST/Nozue2016_SAStranscriptome_scripts?kknitr::opts_chunk/SAS_muts_time_course_RNAseq_finalfinal"
...
#homedir2<-getwd() # default derectory stored in project
#} # customize homedir
...
#} # use git repository
# setwd(homedir) # does not work with new RStudio

# reading necessary funcitons and libraries
knitr::opts_chunk$set(echo = TRUE)
#source(file.path("SAS_muts_time_course_RNAseq_finalfinal/function_RNAseq_time_course.R"))
...
salmon<-DE.genotype.batch.genes.WGCNAmodules.description[DE.genotype.batch.genes.WGCNAmodules.description$WGCNAmodules=="orange",]
salmon$AGI
#
