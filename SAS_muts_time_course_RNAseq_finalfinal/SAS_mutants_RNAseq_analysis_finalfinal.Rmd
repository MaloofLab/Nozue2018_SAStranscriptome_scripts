...
## To do
* remove all NAM parents informaiton (eg. conversion table, DGE, etc)
* 
...
write.csv(SOM.Col.cluster.GOseq.summary,file="../../Nozue2016_SAStranscriptome_output/figs_tables/TableS3_SOM.Col.cluster.GOseq.summary.csv")
```
...
overlap.GOseq<-GOseq.overlapTable(test[,30],test[,i],genes=test$AGI,permutation=100)
...
save(overlap.GOseq.melt.summary, file="../../Nozue2016_SAStranscriptome_output/output/overlap.GOseq.melt.summary.SOM.DEgenes.08171616.Rdata")
load("../../Nozue2016_SAStranscriptome_output/output/overlap.GOseq.melt.summary.SOM.DEgenes.08171616.Rdata")
# # graph
...
# needs to change Var1 levels (081716)
...
ggsave(q4b,file="Fig4_Col.SOM.clusters.vs.GenotypeSpecific.genes.table.s.2.GOseq.081716.pdf",width=13,height=6,path="../../Nozue2016_SAStranscriptome_output/figs_tables")
...
conversion.table
# custom categories
load("../../Nozue2016_SAStranscriptome_data/input/hormone.responsiveness3.Rdata") #new version. check if new version is identical to this. copy the file to this location
...
write.csv("../../Nozue2016_SAStranscriptome_output/output/TableS4_hormone.responsiveness.SOMclusters.description.csv")
# in whitney (060616)
...
# overlap table
i<-2
overlap<-GOseq.overlapTable(test[,28],test[,i],genes=test$AGI,permutation=100)
...
setwd(homrdir)
save(SAS.expression.vst.s.kazu.largeCV.modules,file="../../Nozue2016_SAStranscriptome_output/output/SAS.expression.vst.s.kazu.largeCV.modules.Rdata") 
```
# # overlap table between Col WGCNA module and SOM cluster
# ```{r, eval=FALSE}
# setwd(homedir)
# load("../../Nozue2016_SAStranscriptome_output/output/newdata.vst.Rdata") # 122214
# load("../../Nozue2016_SAStranscriptome_output/output/SAS.expression.vst.s.kazu.largeCV.modules.Rdata")
...
overlap.melt.summary<-overlap.melt[!overlap.melt$Var2=="0",]
for(i in 3:29) {
overlap<-GOseq.overlapTable(test[,30],test[,i],genes=test$AGI,permutation=100)
overlap.melt<-melt(overlap$pTable,id=1) #
overlap.melt$count<-melt(overlap$countTable,id=1)$value
overlap.melt<-overlap.melt[!overlap.melt$Var2=="0",]
overlap.melt.summary<-rbind(overlap.melt.summary,overlap.melt)
