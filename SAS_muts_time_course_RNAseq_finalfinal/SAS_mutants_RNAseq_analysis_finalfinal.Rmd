...
categories <- read.csv("../../Nozue2016_SAStranscriptome_output/figs_tables/TableS7_test.wozero.melt.hormone.signifiant.s.111816.csv",row.names=1,as.is=TRUE)
summary(categories)
head(categories)
...
# newone
load("../../Nozue2016_SAStranscriptome_output/output/overlap.melt.summary.SOM.custom.GOseq.110816.Rdata")
# this data looks strange (111618)
overlap.melt.summary.s<-overlap.melt.summary[!overlap.melt.summary$Var1==0,]
#overlap.melt.summary.s$Var1<-factor(overlap.melt.summary.s$Var1,levels=c(3,6,9,5,8,2,4,11,1,12,7,10)) #
...
test.wozero.melt.hormone.signifiant<-test.wozero.melt[test.wozero.melt$category.cluster %in% overlap.melt.summary.s.significant$category.cluster,]
head(test.wozero.melt.hormone.signifiant)
# remove small group (less than 3)
category.morethan3<-names(table(test.wozero.melt.hormone.signifiant$value)[table(test.wozero.melt.hormone.signifiant$value)>3])
##### under construction #######
test.wozero.melt.hormone.signifiant<-test.wozero.melt.hormone.signifiant[test.wozero.melt.hormone.signifiant$value %in% category.morethan3,] # more than 3 genes
...
#write.csv(test.wozero.melt.hormone.signifiant.s,file="../../Nozue2016_SAStranscriptome_output/output/test.wozero.melt.hormone.signifiant.s.csv") # needs to revise
write.csv(test.wozero.melt.hormone.signifiant.s,file="../../Nozue2016_SAStranscriptome_output/figs_tables/TableS7_test.wozero.melt.hormone.signifiant.s.111816.csv") # needs to revise
```
