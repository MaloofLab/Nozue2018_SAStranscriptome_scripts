...
recut.net<-recutBlockwiseTrees(datExpr,
                      goodSamples=goodSampleGenes.result$goodSamples, goodGenes=goodSampleGenes.result$goodGenes,
  blocks=net$blocks,
...
merge.net<-mergeCloseModules(
 # input data
  ...
  trapErrors = FALSE,
  verbose = 1, indent = 0)
length(table(merge.net$color)) # 31 modules
# higher height with all Genotype
for(x in Genotype) {
merge.net2<-mergeCloseModules(
 # input data
  ...
  trapErrors = FALSE,
  verbose = 1, indent = 0)
length(table(merge.net2$color)) # 22 modules
# save parameters  
