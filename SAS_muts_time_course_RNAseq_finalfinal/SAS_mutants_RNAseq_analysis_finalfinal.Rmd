...
newdata.vst.Col.melt$gt2<-vookup(newdata.vst.Col.melt$gt,conversion.table,2)
head(newdata.vst.Col.melt)
...
ggsave(q4b,file="Fig3_Col.SOM.clusters.vs.my.category.table.s.2.GOseq.111616.png",width=13,height=6,path="../../Nozue2016_SAStranscriptome_output/figs_tables") # testing this with Whitney (110816)
