...
categories$my.category<-factor(categories$my.category,levels=rev(c("IAAup","ABAdown","MJup"))) # 120116
...
write.csv(Fig5B.diff.summary.table.melt.DF,file=file.path("..","..","Nozue2016_SAStranscriptome_output","output","Fig5B.diff.summary.table.melt.DF.csv")) # data used in Fig5B heatmap
...
write.csv(results.df.adj,file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables","Fig5B_response_p_values.v5.csv")) #101017 three categories
...
#
#setwd("../../Nozue2016_SAStranscriptome_output/figs_tables/")
save_plot(file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables","Fig_S2_all.my.category.expression.pattern.v14.101017.png"), my.category.heatmap.all,
          ncol = 3, # we're saving a grid plot of 2 columns
          nrow = 5, # and 2 rows
          base_aspect_ratio = 2.5,
          base_height=6,
