...
write.csv(test.wozero.melt.hormone.significant.sss,file="../../Nozue2016_SAStranscriptome_output/figs_tables/TableS6_test.wozero.melt.hormone.significant.sss.100717.csv") # This should be TableS6? (100717)
```
...
# with new diff calculation (my.category.diff2, 100917)
```{r}
...
categories <- read.csv(file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables","TableS6_test.wozero.melt.hormone.significant.sss.100717.csv"),row.names=1,as.is=TRUE) 
...
write.csv(FigS2.absolute.summary.table.melt.DF.diff,file=file.path("..","..","Nozue2016_SAStranscriptome_output","output","FigS2.absolute.summary.table.melt.DF.diff.csv"))
...
# summary.vst.response.kazu.diff2Col<-as.data.frame(my.category.diff.data2)  # under construction
# 
...
```{r}
response.p.values<-read.csv(file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables","Fig5B_response_p_values.v4.csv"),row.names=1) # from modified Julin's script (copied from Kazu_test_v2.R) (100717)
...
save_plot(file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables","Fig5_all.my.category.diff.expression.pattern.v8.100717.FDR0.01.png"), my.category.heatmap.all,
...
#
#setwd("../../Nozue2016_SAStranscriptome_output/figs_tables/")
save_plot(file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables","Fig_S2_all.my.category.expression.pattern.v13.100717.png"), my.category.heatmap.all,
          ncol = 3, # we're saving a grid plot of 2 columns
          nrow = 5, # and 2 rows
          base_aspect_ratio = 2.5,
          base_height=6,
...
write.csv(DE.genotype.batch.genes.WGCNAmodules.description,file=file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables","Dataset5_Complete_gene_list_of_genes_misexpressed_in_mutant_and_found_in_WGCNA_modules_visualized_in_Fig7_100717.csv")) #091616. Column names were screwed up (111616). Orange > "salmon", "salmon" > "orange4" (121316), 092817
...
test<-read.csv(file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables","Dataset5_Complete_gene_list_of_genes_misexpressed_in_mutant_and_found_in_WGCNA_modules_visualized_in_Fig7_100717.csv"),row.names=1) # does  work (100717)
...
```
# overlap analysis with custome categories (WGCNA modules): Fig6  (no need to change, 100717)
```{r eval=FALSE}
# custom categories
...
## cleaning and plotting  (no need to change, 100717)
```{r}
...
```
# graph  (no need to change, 100717)
```{r}
