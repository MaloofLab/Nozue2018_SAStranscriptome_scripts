...
write.csv(hormone.responsiveness.WGCNAmodules,file=file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables","Supplemental_Dataset5_Custom_category_enrichment_analysis_of_WGCNA_gene_co-expression_modules020818.csv"))
...
#q4 <- q4 + theme(legend.title=element_blank())
ggsave(q4,file="Supplemental_Fig1.phyABDE.Sessa1hvs..my.category.020818.pdf",width=11,height=4,path=file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables"))
ggsave(q4,file="Supplemental_Fig1.phyABDE.Sessa1hvs..my.category.020818.png",width=11,height=4,path=file.path("..","..","Nozue2016_SAStranscriptome_output","figs_tables"))
q4 # magenta indicates pvalue is smaller than 0.01.
```
# Number of Col genes in each module are: 
```{r eval=FALSE} 
