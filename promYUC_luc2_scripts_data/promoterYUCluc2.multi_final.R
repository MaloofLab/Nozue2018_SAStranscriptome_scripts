...
all$value2<-(2^(all$value) -1)*(10^4) # Arbitary units (082216)
...
day<-data.frame(x1=rep(c(0,24,48,0,7,24,48),3),
                x2=rep(c(16,40,57,7,16,40,57),3),
                y1=rep((c(0.9997,0.9997-0.00004,0.9999,0.9999-0.000028,0.9999-0.00007,0.9999-0.00007-0.000036)-1)*10^4,c(3,4,3,4,3,4)),
                y2=rep((c(0.9997+0.000037,0.9997-0.00004+0.000037,0.9999+0.000025,0.9999-0.000003,0.9999-0.00007+0.000032,0.9999-0.00007-0.000036+0.000032)-1)*10^4,c(3,4,3,4,3,4)),
                treatment=rep(c("high \nR/FR","high \nR/FR","high \nR/FR","low \nR/FR","low \nR/FR","low \nR/FR","low \nR/FR"),3),
                promoter=rep(c("YUC5","YUC8","YUC9"),each=7),
                color=rep(c("high \nR/FR","high \nR/FR","high \nR/FR","high \nR/FR","low \nR/FR","low \nR/FR","low \nR/FR"),3))
night<-data.frame(x1=rep(c(16,40),6),
                  x2=rep(c(24,48),6),
                  y1=rep((c(0.9997,0.9997-0.00004,0.9999,0.9999-0.000028,0.9999-0.00007,0.9999-0.00007-0.000036)-1)*10^4,each=2),
                  y2=rep((c(0.9997+0.000037,0.9997-0.00004+0.000037,0.9999+0.000025,0.9999-0.000003,0.9999-0.00007+0.000032,0.9999-0.00007-0.000036+0.000032)-1)*10^4,each=2),
                  treatment=rep(c("high \nR/FR","high \nR/FR","low \nR/FR","low \nR/FR"),3),
                  promoter=rep(c("YUC5","YUC8","YUC9"),each=4)                  
) # y1 and y2 scale changed for arbitary units
...
# write promoter name
#YUC8<-YUC8 + annotate("text",label="YUC8",x=-2,y=(1.00021-1)*10^2) # percent
YUC8<-YUC8 + annotate("text",label="YUC8",x=-2,y=(1.00021-1)*10^4) # Arbitary units
...
YUC9<-YUC9 + annotate("text",label="YUC9",x=-2,y=(1.00023-1)*10^4) # Arbitrary Units
