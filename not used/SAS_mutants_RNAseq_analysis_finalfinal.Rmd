...
source(file.path(homedir,"function_RNAseq_time_course.R"))
...
setwd(homedir)
```
## select genes with largeCV and calculate responsiveness for SOM analysis, updated 082016
```{r eval=FALSE}
setwd(homedir)
...
load("../../Nozue2016_SAStranscriptome_output/output/summary.vst.response.Rdata") #summary.vst.response is object name
...
# To which clusters in mutants do genes in Col cluster 6 belong?
newdata.vst$gt2<-vlookup(newdata.vst$gt,conversion.table,2)
cluster6.Col.AGI<-newdata.vst[newdata.vst$gt==1 & newdata.vst$ssom3.4.unit.classif==6,"AGI"]
ftable(newdata.vst[newdata.vst$AGI %in% cluster6.Col.AGI,c("gt2","ssom3.4.unit.classif")])
#
cluster10.Col.AGI<-newdata.vst[newdata.vst$gt==1 & newdata.vst$ssom3.4.unit.classif==10,"AGI"]
ftable(newdata.vst[newdata.vst$AGI %in% cluster10.Col.AGI,c("gt2","ssom3.4.unit.classif")])
...
```
# SOM analysis only with DE genes in Col (112616)
```{r}
setwd(homedir)
load("../../Nozue2016_SAStranscriptome_output/output/DGEsummary.edgeR.response.Rdata")
...
save(SOM.onlyCol.112616,file="../../Nozue2016_SAStranscriptome_output/output/SOM.onlyCol.112616.Rdata")
#### making complete table (for SOM data) ###
load("../../Nozue2016_SAStranscriptome_output/output/SOM.onlyCol.112616.Rdata") 
...
write.csv(SOM.onlyCol.112616.clusters.description,"../../Nozue2016_SAStranscriptome_output/figs_tables/TableS3.SOM.onlyCol.112616.clusters.description.csv") #090116
# graph
...
p <- p + coord_flip()
p 
ggsave("Fig2b_Coexpression_clusters_of_shade-responsive_genes_onlyCol_112616.pdf",width=11,height=5,unit="in",path="../../Nozue2016_SAStranscriptome_output/figs_tables") # only Col DE genes
