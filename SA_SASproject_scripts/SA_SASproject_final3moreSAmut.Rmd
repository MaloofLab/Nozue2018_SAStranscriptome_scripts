...
floweringtime.data<-floweringtime.data %>% filter(!plant=="npr2/3/4")
plot.all<-graph.leafpos.selecttraits(leaf.start = 3,leaf.end=8,plot.traits=c("PL","PBL","bolted days","hyp"),file.name="../../Nozue2016_SAStranscriptome_output/figs_tables/Fig8_plot.moreSAmut.leaf3.8.PL.PBL.hy.FT.PlantCell.png")
